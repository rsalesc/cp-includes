...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tests/judge/watto.cpp\"\n#include <bits/stdc++.h>\n#line\
  ...
  verifiedWith: []
documentation_of: tests/judge/watto.cpp
layout: document
redirect_from:
- /library/tests/judge/watto.cpp
- /library/tests/judge/watto.cpp.html
