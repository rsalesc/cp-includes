...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tests/judge/fft.cpp\"\n#include <bits/stdc++.h>\n#line 1\
    \ \"PolynomialRing.cpp\"\n\n\n#line 1 \"Epsilon.cpp\"\n\n\n#line 4 \"Epsilon.cpp\"\
    ...
    \ * k, sz) * (p[i] ^ k);\n    if(i == 0) return D % n;\n    long long S = k *\
    \ i;\n    D <<= S;\n    return D % n;\n  }\n  return {};\n}\n} // namespace series\n\
    } // namespace lib\n\n\n#line 4 \"tests/judge/fft.cpp\"\n\nusing namespace std;\n\
    using namespace lib;\n\nconst int MOD = (int)1e9+7;\nusing Poly = math::Polynomial<Mint64<MOD>,\
    \ math::poly::NaiveMultiplication>;\n\nint main() {\n  Poly a = {0, 3};\n  Poly\
    ...
    \ = Poly::divmod(y, root);\n  cout << y << endl;\n  cout << p.first << \" \" <<\
    \ p.second << \" \" << (p.first * root + p.second) << endl;\n\n  auto pq = Poly::power(a,\
    \ 4, Poly({1, 1}));\n  cout << pq << endl;\n\n  cout << \"integral\" << endl;\n\
    \  cout << w << endl;\n  cout << y.integral() << endl;\n  cout << y.derivative()\
    \ << endl;\n\n  cout << \"series\" << endl;\n  cout << series::power(Poly(31),\
    \ 2, 1) << endl;\n  cout << series::power(root, 1023912, 4) << \" \" << Poly::power(root,\
    \ 1023912, 4) << endl;\n  auto pw = 10293109239012;\n  assert(series::power(w,\
    \ pw, 50) == Poly::power(w, pw, 50));\n}\n"
  code: "#include <bits/stdc++.h>\n#include \"../../PolynomialRing.cpp\"\n#include\
    ...
    \ cout << series::power(root, 1023912, 4) << \" \" << Poly::power(root, 1023912,\
    \ 4) << endl;\n  auto pw = 10293109239012;\n  assert(series::power(w, pw, 50)\
    \ == Poly::power(w, pw, 50));\n}\n"
  dependsOn:
  - PolynomialRing.cpp
  - Epsilon.cpp
  ...
  verifiedWith: []
documentation_of: tests/judge/fft.cpp
layout: document
redirect_from:
- /library/tests/judge/fft.cpp
- /library/tests/judge/fft.cpp.html
