...
data:
  ...
  bundledCode: "#line 1 \"ModularInteger.cpp\"\n\n\n#line 1 \"NumberTheory.cpp\"\n\
    ...
    } // namespace hashing\n} // namespace lib\n\n\n#line 4 \"tests/judge/hash.cpp\"\
    \n\nusing namespace std;\nusing namespace lib;\n\nconst int MOD = 5;\ntypedef\
    \ Mint32<MOD, 2 * MOD> mint;\n\nint32_t main() {\n  mint a = 1;\n  a ^ 3;\n}\n"
  code: "#include \"../../ModularInteger.cpp\"\n#include \"../../RollingHash.cpp\"\
    \n#include <bits/stdc++.h>\n\nusing namespace std;\nusing namespace lib;\n\nconst\
    \ int MOD = 5;\ntypedef Mint32<MOD, 2 * MOD> mint;\n\nint32_t main() {\n  mint\
    \ a = 1;\n  a ^ 3;\n}\n"
  dependsOn:
  - ModularInteger.cpp
  - NumberTheory.cpp
  ...
  verifiedWith: []
documentation_of: tests/judge/hash.cpp
layout: document
redirect_from:
- /library/tests/judge/hash.cpp
- /library/tests/judge/hash.cpp.html
