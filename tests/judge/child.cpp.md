...
data:
  ...
  bundledCode: "#line 1 \"SegtreeBeats.cpp\"\n\n\n#line 1 \"Segtree.cpp\"\n\n\n#include\
    ...
    \ namespace lib\n\n\n#line 3 \"tests/judge/child.cpp\"\n#define int long long\n\
    \nusing namespace std;\nusing namespace lib;\n\nstruct Data {\n  int x, mx, mn,\
    \ lz;\n  Data() : lz(-1) {}\n  Data(int x) : x(x), mx(x), mn(x), lz(-1) {}\n};\n\
    \nstruct Pushdown {\n  void operator()(Data &no, int l, int r, Data *ln, Data\
    \ *rn) const {\n    if (no.lz == -1)\n      return;\n    if (l != r) {\n     \
    \ ln->lz = no.lz;\n      rn->lz = no.lz;\n    }\n    no.mx = no.mn = no.lz;\n\
    \    no.x = no.lz * (r - l + 1);\n    no.lz = -1;\n  }\n};\n\nstruct Combiner\
    ...
    \     cin >> x >> v;\n      x--;\n      SetTagger tagger = {v};\n      tree.update(x,\
    \ x, tagger);\n    }\n  }\n}\n"
  code: "#include \"../../SegtreeBeats.cpp\"\n#include <bits/stdc++.h>\n#define int\
    \ long long\n\nusing namespace std;\nusing namespace lib;\n\nstruct Data {\n \
    \ int x, mx, mn, lz;\n  Data() : lz(-1) {}\n  Data(int x) : x(x), mx(x), mn(x),\
    \ lz(-1) {}\n};\n\nstruct Pushdown {\n  void operator()(Data &no, int l, int r,\
    \ Data *ln, Data *rn) const {\n    if (no.lz == -1)\n      return;\n    if (l\
    \ != r) {\n      ln->lz = no.lz;\n      rn->lz = no.lz;\n    }\n    no.mx = no.mn\
    \ = no.lz;\n    no.x = no.lz * (r - l + 1);\n    no.lz = -1;\n  }\n};\n\nstruct\
    \ Combiner {\n  Data operator()(const Data &a, const Data &b) const {\n    Data\
    \ data;\n    data.x = a.x + b.x;\n    data.mx = max(a.mx, b.mx);\n    data.mn\
  ...
  verifiedWith: []
documentation_of: tests/judge/child.cpp
layout: document
redirect_from:
- /library/tests/judge/child.cpp
- /library/tests/judge/child.cpp.html
