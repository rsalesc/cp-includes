...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"tests/judge/concat.cpp\"\n#include <bits/stdc++.h>\n#line\
    \ 1 \"Graph.cpp\"\n\n\n#line 1 \"Traits.cpp\"\n\n\n#line 4 \"Traits.cpp\"\n\n\
    namespace lib {\nusing namespace std;\nnamespace traits {\n\ntemplate <typename...>\
  ...
  verifiedWith: []
documentation_of: tests/judge/concat.cpp
layout: document
redirect_from:
- /library/tests/judge/concat.cpp
- /library/tests/judge/concat.cpp.html
