...
data:
  ...
  bundledCode: "#line 1 \"PolynomialRing.cpp\"\n\n\n#line 1 \"Epsilon.cpp\"\n\n\n\
    ...
    ** internal error **\");\n            break;\n        }\n    }\n\nprivate:\n \
    ...
    fast interpolation\", \"[polynomial]\") {\n  using Field = MintNTT;\n  using Poly\
    \ = Polynomial<Field, NTTMultiplication, poly::DefaultDivmod>;\n  Poly p = {0,\
    \ 1, 3};\n\n  vector<Field> w = {0, 2, 4};\n\n  MultipointEvaluation<Poly> me(w);\n\
    \  auto res_mid = me.eval(p);\n  auto res = me.interp(res_mid.begin(), res_mid.end());\n\
    \n  REQUIRE_THAT(res.p, Catch::Equals(p.p));\n}\n\nTEST_CASE(\"Polynomial<MintNTT>\
    \ fast multiplication\", \"[polynomial]\") {\n  using Poly = Polynomial<MintNTT,\
    ...
    Polynomial<double> fast multiplication\", \"[polynomial]\") {\n  using Poly =\
    \ Polynomial<double, FFTMultiplication>;\n  Poly p = {0, 1, 3, 5, 7, 9, 11};\n\
    \  Poly q = {1, 3, 5, 11, 13};\n\n  auto r1 = p * q;\n\n  using Poly2 = Polynomial<double,\
    \ NaiveMultiplication>;\n  Poly2 a = {0, 1, 3, 5, 7, 9, 11};\n  Poly2 b = {1,\
    ...
    \ FHT multiplication\", \"[polynomial]\") {\n  using Poly = Polynomial<MintNTT,\
    \ FHTMultiplication>;\n  Poly p = {0, 1, 3, 5, 7, 9, 11};\n  Poly q = {1, 3, 5,\
    \ 11, 13};\n\n  auto r1 = p * q;\n\n  using Poly2 = Polynomial<MintNTT, NaiveMultiplication>;\n\
    \  Poly2 a = {0, 1, 3, 5, 7, 9, 11};\n  Poly2 b = {1, 3, 5, 11, 13};\n\n  auto\
    \ r2 = a * b;\n\n  REQUIRE_THAT(r1.p, Catch::Equals(r2.p));\n}\n"
  code: "#include \"../../PolynomialRing.cpp\"\n#include \"../../FFT.cpp\"\n#include\
    \ \"../../ModularInteger.cpp\"\n#include \"../../NTT.cpp\"\n#include \"../../FHT.cpp\"\
  ...
  verifiedWith: []
documentation_of: tests/unit/PolynomialRing.cpp
layout: document
redirect_from:
- /library/tests/unit/PolynomialRing.cpp
- /library/tests/unit/PolynomialRing.cpp.html
