...
data:
  ...
  bundledCode: "#line 1 \"Lambda.cpp\"\n\n\n#include <bits/stdc++.h>\n#line 1 \"Traits.cpp\"\
    ...
    ** internal error **\");\n            break;\n        }\n    }\n\nprivate:\n \
    ...
    \ vs = {\"a\", \"b\", \"c\", \"d\"};\n    SubsetMap<string> m(vs.size(), [&](int\
    \ i) -> string {\n      return vs[i] + vs[i];\n    });\n    vector<string> res\
    \ = m();\n    vector<string> expected = {\"aa\", \"bb\", \"cc\", \"dd\"};\n  \
  ...
  code: "#include \"../../Lambda.cpp\"\n#include \"../catch.hpp\"\n\nusing namespace\
    ...
    \  }\n\n  SECTION(\"test conversion\") {\n    std::function<int(int)> f = Map<int>([](int\
    \ i) { return i%2; });\n    REQUIRE(f(42) == 0);\n    REQUIRE(f(43) == 1);\n \
    ...
    \ Catch::Equals(f(vs.begin(), vs.end())));\n  }\n  SECTION(\"test subset filter\"\
    ) {\n    vector<int> vs = {10, 20, 30, 40, 50};\n    auto fs = f.subset(vs.size(),\
    \ [&](int i) {\n      return vs[i] * 2;\n    });\n    vector<int> expected = {40,\
    \ 80};\n    REQUIRE_THAT(expected, Catch::Equals(fs()));\n    REQUIRE(fs(0) ==\
    \ 40);\n    REQUIRE(fs(1) == 80);\n  }\n  SECTION(\"test subset negation\") {\n\
    \    vector<int> vs = {10, 20, 30, 40, 50};\n    auto fs = !SubsetFilter(vs.size(),\
  ...
  verifiedWith: []
documentation_of: tests/unit/Lambda.cpp
layout: document
redirect_from:
- /library/tests/unit/Lambda.cpp
- /library/tests/unit/Lambda.cpp.html
