...
data:
  ...
  bundledCode: "#line 1 \"MontgomeryInteger.cpp\"\n\n\n#include <bits/stdc++.h>\n\n\
    ...
    ** internal error **\");\n            break;\n        }\n    }\n\nprivate:\n \
    ...
    \  }\n}\n"
  code: "#include \"../../MontgomeryInteger.cpp\"\n#include \"../catch.hpp\"\n\nusing\
    \ namespace lib;\n\nusing mint = MontNTT;\nusing mint17 = Mont32<17>;\n\nTEST_CASE(\"\
    addition\") {\n  WHEN(\"using NTT mod\") {\n    mint a = 3;\n    mint b = 5;\n\
    \n    REQUIRE(8 == (a + b).get());\n  }\n  WHEN(\"using 17 mod\") {\n    mint17\
    \ a = 12;\n    mint17 b = 10;\n\n    REQUIRE(5 == (a + b).get());\n  }\n}\n\n\
  ...
  verifiedWith: []
documentation_of: tests/unit/MontgomeryInteger.cpp
layout: document
redirect_from:
- /library/tests/unit/MontgomeryInteger.cpp
- /library/tests/unit/MontgomeryInteger.cpp.html
