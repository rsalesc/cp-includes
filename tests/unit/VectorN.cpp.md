...
data:
  ...
  verifiedWith: []
documentation_of: tests/unit/VectorN.cpp
layout: document
redirect_from:
- /library/tests/unit/VectorN.cpp
- /library/tests/unit/VectorN.cpp.html
