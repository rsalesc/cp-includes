...
data:
  ...
  bundledCode: "#line 1 \"Symbolic.cpp\"\n\n\n#include <bits/stdc++.h>\n\nnamespace\
    ...
    ** internal error **\");\n            break;\n        }\n    }\n\nprivate:\n \
    ...
    \                      {c, 2},\n                                   });\n\n  REQUIRE(result\
    \ == 110);\n}\n"
  code: "#include \"../../Symbolic.cpp\"\n#include \"../catch.hpp\"\n\nusing namespace\
    \ lib;\n\nTEST_CASE(\"eval symbolic expression\", \"[symbolic]\") {\n  auto a\
    \ = Variable<int>::get_variable();\n  auto b = Variable<int>::get_variable();\n\
    \  auto c = Variable<int>::get_variable();\n\n  auto exp = (a * 3 + b * 2 + c)\
    \ * 2;\n\n  auto visitor = std::make_unique<EvalVisitor<int>>();\n  auto result\
    \ = visitor->eval(exp, {\n                                       {a, 15},\n  \
    \                                     {b, 4},\n                              \
  ...
  verifiedWith: []
documentation_of: tests/unit/Symbolic.cpp
layout: document
redirect_from:
- /library/tests/unit/Symbolic.cpp
- /library/tests/unit/Symbolic.cpp.html
