...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"polynomial/MultipointEvaluation.cpp\"\n\n\n#line 1 \"PolynomialRing.cpp\"\
    \n\n\n#line 1 \"Epsilon.cpp\"\n\n\n#include <bits/stdc++.h>\n\nnamespace lib {\n\
    ...
    \  }\n\n};\n} // namespace math\n} // namespace lib\n\n\n"
  code: "#ifndef _LIB_POLYNOMIAL_MULTIPOINT_EVALUATION\n#define _LIB_POLYNOMIAL_MULTIPOINT_EVALUATION\n\
  ...
  verifiedWith: []
documentation_of: polynomial/MultipointEvaluation.cpp
layout: document
redirect_from:
- /library/polynomial/MultipointEvaluation.cpp
- /library/polynomial/MultipointEvaluation.cpp.html
