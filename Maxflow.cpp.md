...
data:
  ...
  bundledCode: "#line 1 \"Maxflow.cpp\"\n\n\n#line 1 \"Graph.cpp\"\n\n\n#line 1 \"\
    ...
    \    }\n    return 0;\n  }\n\n  T blocking_flow() {\n    if (!layered_bfs())\n\
    \      return 0;\n    used.assign(size(), 0);\n    T aug, flow = 0;\n    while\
    \ ((aug = augmenting_path(source, numeric_limits<T>::max())))\n      flow += aug;\n\
    \    return flow;\n  }\n\n  T maxflow() {\n    T aug, flow = 0;\n    while ((aug\
    \ = blocking_flow()))\n      flow += aug;\n    return flow;\n  }\n\n  vector<bool>\
    \ mincut() const {\n    int n = size();\n    vector<bool> vis(n);\n    vector<int>\
    \ q;\n    q.reserve(n);\n    q.push_back(source);\n    vis[source] = true;\n \
