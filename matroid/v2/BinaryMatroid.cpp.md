...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"matroid/v2/BinaryMatroid.cpp\"\n\n\n#include <bits/stdc++.h>\n\
    ...
    \ > 0;\n    return res;\n  }\n};\n} // namespace lib\n\n\n"
  code: "#ifndef _LIB_BINARY_MATROID\n#define _LIB_BINARY_MATROID\n#include <bits/stdc++.h>\n\
    #include \"Matroid.cpp\"\n\nnamespace lib {\n  using namespace std;\nnamespace\
  ...
  verifiedWith: []
documentation_of: matroid/v2/BinaryMatroid.cpp
layout: document
redirect_from:
- /library/matroid/v2/BinaryMatroid.cpp
- /library/matroid/v2/BinaryMatroid.cpp.html
