...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"matroid/ColorMatroid.cpp\"\n\n\n#include <bits/stdc++.h>\n\
  ...
  verifiedWith: []
documentation_of: matroid/ColorMatroid.cpp
layout: document
redirect_from:
- /library/matroid/ColorMatroid.cpp
- /library/matroid/ColorMatroid.cpp.html
